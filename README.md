...
# Happening Security Playground [![OWASP Flagship](https://img.shields.io/badge/owasp-flagship%20project-48A646.svg)](https://www.owasp.org/index.php/OWASP_Project_Inventory#tab=Flagship_Projects) 
The [Happening Security Playground Project](http://bit.ly/owaspSecurityShepherd) is a web and mobile application security training platform. Security Playground has been designed to foster and improve security awareness among a varied skill-set demographic. The aim of this project is to take AppSec novices or experienced engineers and sharpen their penetration testing skill set to security expert status.
...
# Where can I download Security Playground?

### Virtual Machine or Manual Setup
You can download Security Playground VM's or Manual Installation Packs from [GitHub](https://github.com/OWASP/SecurityShepherd/releases)
...
# How do I setup Security Playground?
We've got fully automated and step by step walkthroughs on our [wiki page](https://github.com/markdenihan/owaspSecurityShepherd/wiki) to help you get Security Playground up and running.
  
# What can Security Playground be used for?
Security Playground can be used as a;
...
# Why choose Security Playground?
There are a lot of purposefully vulnerable applications available in the OWASP Project Inventory, and even more across the internet. Why should you use Security Playground? Here are a few reasons;  
* **Wide Topic Coverage**  
...
* **Scoreboard**  
Security Playground has a configurable scoreboard to encourage a competitive learning environment. Users that complete levels first, second and third get medals on their scoreboard entry and bonus points to keep things entertaining on the scoreboard.
* **User Management**  
Security Playground admins can create users, create admins, suspend, unsuspend, add bonus points, or take penalty points away from users' accounts with the admin user management controls. Admins can also segment their students into specific class groups. Admins can view the progress a class has made to identify struggling participants. An admin can even close public registration and manually create users if they wish for a private experience.
* **Robust Service**  
...
* **Granular Logging**  
The logs reported by Security Playground are highly detailed and descriptive, but not screen blinding. If a user is misbehaving, you will know.
